...
from sglang.srt.groq_api_adapter import (
    load_chat_template_for_groq_api,
    v1_chat_completions,
    v1_completions,
)
...
async def groq_v1_completions(raw_request: Request):
    return await v1_completions(tokenizer_manager, raw_request)


@app.post("/v1/chat/completions")
async def groq_v1_chat_completions(raw_request: Request):
...
def launch_server(server_args: ServerArgs, pipe_finish_writer, model_overide_args=None):
    ...
    if server_args.chat_template:
        ...
        load_chat_template_for_groq_api(server_args.chat_template)
